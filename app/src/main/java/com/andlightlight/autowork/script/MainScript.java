...
public class MainScript extends ScriptInterface {
    ...
    void RoundClick() throws InterruptedException {
        ...
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(597.000000f,1185.000000f, 45)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(670.000000f,1197.000000f, 50)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(665.000000f,1276.000000f, 27)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(653.000000f,1360.000000f, 51)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(581.000000f,1386.000000f, 50)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(483.000000f,1380.000000f, 47)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(434.000000f,1374.000000f, 65)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(449.000000f,1289.000000f, 49)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(451.000000f,1221.000000f, 49)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(495.000000f,1293.000000f, 36)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(578.000000f,1248.000000f, 52)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(537.000000f,1322.000000f, 35)});
        sleep(allDelay);
        CheckAndRengQiu();
        click(new GestureManager.Point[]{new GestureManager.Point(530.000000f,1219.000000f, 10)});
    }
    ...
    void RunUp() throws InterruptedException {
        ...
        if (re.rePoint.x > 0f && re.rePoint.y > 0f) {
            ...
            click(new GestureManager.Point[]{new GestureManager.Point(startX,startY,10),new GestureManager.Point(endX,endY, 2000)});
            sleep(5000);
            click(endX,endY);
        }
    }
